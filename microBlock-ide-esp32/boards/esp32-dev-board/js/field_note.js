...
let note_collection = [
  {
    name: "全家歡迎音樂",
    notes: "E5 C5 G4 C5 D5 G5 G5 D5 E5 D5 G4 C5"
  },
  {
    name: "音階",
    //name: "Scale",
...
CustomFields.FieldNote.prototype.showEditor_ = function() {
  ...
  let addNoteColumn = function(n) {
    ...
    for (let i=0;i<n;i++) {
      ...
      html += `<ul>`;
      html += `<li><input type="radio" name="note-${this._radioNextIndex}" value="C7"${notesArr ? notesArr[i] === "C7" ? "checked" : "" : ""}></li>`;
      html += `<li><input type="radio" name="note-${this._radioNextIndex}" value="B6"${notesArr ? notesArr[i] === "B6" ? "checked" : "" : ""}></li>`;
      html += `<li><input type="radio" name="note-${this._radioNextIndex}" value="A6"${notesArr ? notesArr[i] === "A6" ? "checked" : "" : ""}></li>`;
      html += `<li><input type="radio" name="note-${this._radioNextIndex}" value="G6"${notesArr ? notesArr[i] === "G6" ? "checked" : "" : ""}></li>`;
      html += `<li><input type="radio" name="note-${this._radioNextIndex}" value="F6"${notesArr ? notesArr[i] === "F6" ? "checked" : "" : ""}></li>`;
      html += `<li><input type="radio" name="note-${this._radioNextIndex}" value="E6"${notesArr ? notesArr[i] === "E6" ? "checked" : "" : ""}></li>`;
      html += `<li><input type="radio" name="note-${this._radioNextIndex}" value="D6"${notesArr ? notesArr[i] === "D6" ? "checked" : "" : ""}></li>`;
      ...
      html += `<li><input type="radio" name="note-${this._radioNextIndex}" value="B4"${notesArr ? notesArr[i] === "B4" ? "checked" : "" : ""}></li>`;
      html += `<li><input type="radio" name="note-${this._radioNextIndex}" value="A4"${notesArr ? notesArr[i] === "A4" ? "checked" : "" : ""}></li>`;
      html += `<li><input type="radio" name="note-${this._radioNextIndex}" value="G4"${notesArr ? notesArr[i] === "G4" ? "checked" : "" : ""}></li>`;
      html += `<li><input type="radio" name="note-${this._radioNextIndex}" value="F4"${notesArr ? notesArr[i] === "F4" ? "checked" : "" : ""}></li>`;
      html += `<li><input type="radio" name="note-${this._radioNextIndex}" value="E4"${notesArr ? notesArr[i] === "E4" ? "checked" : "" : ""}></li>`;
      html += `<li><input type="radio" name="note-${this._radioNextIndex}" value="D4"${notesArr ? notesArr[i] === "D4" ? "checked" : "" : ""}></li>`;
      html += `<li><input type="radio" name="note-${this._radioNextIndex}" value="C4"${notesArr ? notesArr[i] === "C4" ? "checked" : "" : ""}></li>`;
  ...
  html += `<div class="menu">`;
  html += `<div class="custom active">自製曲目區</div>`;
  html += `<div class="collection">常見曲目區</div>`;
  html += `</div>`;
